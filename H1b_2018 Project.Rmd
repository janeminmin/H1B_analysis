...
```{r}
library(tidyverse)
h1b<-read_csv("C:/Users/Minjie/Documents/2018 Fall Master/Data visualization/Project/h1b18.csv")
summary(h1b)
```
```{r}
glimpse(h1b)
...
prop_mean%>%
        ...
        ylim(0,1)+
        xlab("Case Status")+
        ylab("Mean of proportion based on case status")
...
docs <- Corpus(VectorSource(h1b$SOC_NAME))
...
docs <- tm_map(docs, toSpace, "OTHER")
...
h1b %>%
        ...
        ggplot(aes(x=EMPLOYER_NAME,y=number,group=CASE_STATUS,color=CASE_STATUS)) +
        geom_point(size=2)+
        geom_line(size=2)+
        theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
...
headers <- read.csv("C:/Users/Minjie/Documents/2018 Fall Master/Data visualization/Project/PEP_2018_PEPANNRSIP.US12A_with_ann.csv", header = FALSE, nrows = 2, as.is = T)

population<-read.csv("C:/Users/Minjie/Documents/2018 Fall Master/Data visualization/Project/PEP_2018_PEPANNRSIP.US12A_with_ann.csv",header=FALSE,skip=2)
...
write.csv(state_based,"C:/Users/Minjie/Documents/2018 Fall Master/Data visualization/Project/state_pop_h1b.csv", row.names = FALSE)
...
month_trend<-h1b %>%
        ...
        select(CASE_STATUS,month_submit,month_decision,month_start)
```
